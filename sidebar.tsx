...
import { Home, Mic, Calendar, Cpu, Mail, Zap } from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  const navItems = [
    ...
    { id: 'notes', icon: Mic, label: 'Voice Notes' },
    { id: 'schedule', icon: Calendar, label: 'Schedule & Focus' },
    { id: 'ai', icon: Cpu, label: 'AI Intelligence' },
    { id: 'email', icon: Mail, label: 'Email Triage' },
  ] as const;
